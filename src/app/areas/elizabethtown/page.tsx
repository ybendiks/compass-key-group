...
export default function ElizabethtownPage() {
  const placeSchema = {
    ...
    description:
      "Explore real estate in Elizabethtown KY — neighborhoods, schools, housing prices, and lifestyle info from Compass and Key Group.",
    geo: {
      "@type": "GeoCoordinates",
      latitude: 37.6934,
      longitude: -85.8591,
    },
    url: `${SITE_URL}/areas/elizabethtown`,
  };
      ...
      <section className="bg-white py-12 lg:py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimateOnScroll>
            ...
            <IdxWidget
              src="//compassandkeygroup.idxbroker.com/idx/customshowcasejs.php?widgetid=35738"
              id="idxwidgetsrc-35738"
            />
